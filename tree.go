...
// bleh.  this code started out in the bio package, then got moved to the graph
// package, but it's too quirky and special purporse for graph.  moved here
// now as a non-exported function.
